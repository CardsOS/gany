...
1. [Reporting security problems to Gany](#reporting)
...
<a name="reporting"></a>
## Reporting security problems to Gany
...
The security point of contact is Gany's maintainer, Emil Sayahi. Emil responds to security
...
I will create a comment in [the official "Updates" issue](https://github.com/Dirout/gany/issues/3) to inform users about
...
A large chunk of the code being run on your machine when you start Gany is not Gany itself, 
but, rather, the many dependencies it relies on. Even if Gany itself is secure, one of its dependencies may
have security vulnerabilities; if a dependency has a vulnerability, it will likely be patched, and it is important
that we incorporate those patches into Gany.
